...
```{r results-plot, fig.height=6, fig.cap="ARI and k-NN purity for each method. Dashed line = standard UMAP baseline."}
library(tidyr)
...
```{r umap-grid, fig.height=12, fig.cap="All methods coloured by ADT-derived protein label."}
...
- k-NN purity differences are small across all methods, indicating UMAP topology
  is broadly preserved — the main effect is on Louvain cluster resolution.
